...
class Heap<T extends IHeapItem> {
    ...
    public removeWhere(predicate: (el: T) => boolean) {
        ...
        for (const el of this.array) {
            if (predicate(el)) {
                Logger.error("Idx of element not removed: " + this.keyMap.get(el.getKey()));
    ...
    public dump(): void {
        ...
        Logger.debug("Heap array: " + JSON.stringify(this.array));
        Logger.debug("--- keymap ---");
        Logger.debug("KeyMap: " + JSON.stringify(this.keyMap));
    }
