...
export class FacetBorderTracer {
    ...
    private static getPath(pt: PathPoint, facetResult: FacetResult, f: Facet, borderMask: BooleanArray2D, xWall: BooleanArray2D, yWall: BooleanArray2D) {
        ...
        while (!finished) {
            if (debug) {
                Logger.debug(`${pt.x} ${pt.y} ${pt.orientation}`);
            }
            ...
            if (pt.orientation === OrientationEnum.Left) {
                ...
                if (((pt.y - 1 >= 0 && facetResult.facetMap.get(pt.x, pt.y - 1) !== f.id) // top exists and is a neighbour facet
                    ...
                    if (debug) {
                        Logger.debug("can place top _ wall at x,y");
                    }
                ...
                if (((pt.y + 1 < facetResult.height && facetResult.facetMap.get(pt.x, pt.y + 1) !== f.id) // bottom exists and is a neighbour facet
                    ...
                    if (debug) {
                        Logger.debug("can place bottom _ wall at x,y");
                    }
                ...
                if (pt.y - 1 >= 0 // top exists
                    ...
                    if (debug) {
                        Logger.debug(`can place left | wall at x,y-1`);
                    }
                ...
                if (pt.y - 1 >= 0 && pt.x - 1 >= 0 // there is a left upwards
                    ...
                    if (debug) {
                        Logger.debug("can place bottom _ wall at x-1,y-1");
                    }
                ...
                if (pt.y + 1 < facetResult.height && pt.x - 1 >= 0 // there is a left downwards
                    ...
                    if (debug) {
                        Logger.debug("can place top _ wall at x-1,y+1");
                    }
                ...
                if (((pt.x - 1 >= 0
                    ...
                    if (debug) {
                        Logger.debug("can place left | wall at x,y");
                    }
                ...
                if (((pt.x + 1 < facetResult.width
                    ...
                    if (debug) {
                        Logger.debug("can place right | wall at x,y");
                    }
                ...
                if (pt.x - 1 >= 0
                    ...
                    if (debug) {
                        Logger.debug(`can place top _ wall at x-1,y`);
                    }
                ...
                if (pt.y - 1 >= 0 && pt.x - 1 >= 0 // there is a left upwards
                    ...
                    if (debug) {
                        Logger.debug("can place right | wall at x-1,y-1");
                    }
                ...
                if (pt.y - 1 >= 0 && pt.x + 1 < facetResult.width // there is a right upwards
                    ...
                    if (debug) {
                        Logger.debug("can place left |  wall at x+1,y-1");
                    }
                ...
                if (pt.y - 1 >= 0
                    ...
                    if (debug) {
                        Logger.debug(`can place right | wall at x,y-1`);
                    }
                ...
                if (pt.x - 1 >= 0
                    ...
                    if (debug) {
                        Logger.debug(`can place bottom _ wall at x-1,y`);
                    }
